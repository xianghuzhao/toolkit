...
INSERT INTO PilotCache (Site,CE,Status,PilotJobEff,PilotsPerJob,LastCheckTime) SELECT Site,CE,Status,PilotJobEff,PilotsPerJob,LastCheckTime FROM PilotCache_old; 
